...
<div class="ibox-content">
		<div class="row">
			<div id="crop-avatar" class="col-md-6">
				<div class="avatar-view" title="Change Logo Picture" onclick="globalShade()">
...
$(function(){
	...
	//获取页面的可视区域高度和宽度
	var wHeight=window.parent.document.documentElement.clientHeight;
	var oMask=window.parent.document.getElementById("mask");
	var oMaskIframe=document.getElementById("avatar-modal");
	alert(oMask.style.height);
...
<!-- <div>
	<form id="uploader" action="" enctype="multipart/form-data" method="post">
		...
		<img id="clickToUpload" src="resource/doccenter/default/upload_big_img.png">
		<input type="file" class="file" id="" name="files" onchange="submitForm();">
		<span class="delimgbtn" id="delimgbtn">x</span>
		<script type="text/javascript">
		$(function(){
			$("#upload_big_img").hover(function(){
				$("#delimgbtn").css("display","block");
			},function(){
				$("#delimgbtn").hide();
			});
			$("#delimgbtn").click(function(){
				parent.document.getElementById('newsphoto').value = '';
				$("#clickToUpload").attr("src","https://s1.c.meishij.net/n/images/upload_step_img.png");
				$("#upload_big_img").unbind("hover");
				$("#delimgbtn").hide();
			});
		});
		</script>
